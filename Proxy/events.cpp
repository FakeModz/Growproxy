...
bool events::out::pingreply(gameupdatepacket_t* packet) {
    ...
    packet->m_player_flagsopt/effect flags. good to have as 0 if using mod noclip, or etc.
    return false;
}
...
"\nadd_spacer|small|\n\nadd_url_button||`1Youtube``|NOFLAGS|https://youtube.com/c/FakeModzGT|Open link?|0|0|"
"\nadd_textbox|`wMarch : `5Don't Forget to Subscribe |left|"
"\nadd_spacer|small|"
"\nadd_textbox|`wMarch : `9Credits : SrMotion, Ama6nen |left|"
"\nadd_spacer|small|"
